...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4GHpxCBd5HsYzZ6CR5uE";           // TODO 改这里
    static final String accessKeySecret = "w1UhlrKvjRsJgVl1TCQPvkNnfXUglL"; // TODO 改这里
    ...
    public static SendSmsResponse sendSms(String userPhone,String userCode) throws ClientException {
        ...
        request.setTemplateCode("SMS_197455339");  // TODO 改这里
...
/* public static void main(String[] args) throws Exception {
         ...
         SendSmsResponse sendSms =sendSms("15516998704",code);//填写你需要测试的手机号码
